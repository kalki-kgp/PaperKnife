...
export default function AndroidToolsView({ tools }: { tools: Tool[] }) {
  ...
  const categoryColors: Record<ToolCategory, { bg: string, text: string, icon: string, border: string }> = {
    ...
    Signatures: { bg: 'bg-rose-50 dark:bg-rose-900/10', text: 'text-rose-600 dark:text-rose-400', icon: 'text-rose-500', border: 'border-rose-100/50 dark:border-rose-900/20' }
  }
