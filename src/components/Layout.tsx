...
const categoryColors: Record<ToolCategory, { bg: string, text: string, hover: string, iconBg: string }> = {
  ...
  Signatures: { bg: 'bg-rose-50 dark:bg-rose-900/20', text: 'text-rose-500', hover: 'hover:bg-rose-50 dark:hover:bg-rose-900/10', iconBg: 'bg-rose-100 dark:bg-rose-900/30' }
}
