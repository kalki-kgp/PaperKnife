...
import { 
  ...
  Wrench, ImagePlus, FileImage, Palette, X, ChevronDown, GitCompare, Crop as CropIcon, ShieldCheck
} from 'lucide-react'
...
const VerifySignatureTool = lazy(() => import('./components/tools/VerifySignatureTool'))
...
const tools: Tool[] = [
  ...
  { title: 'Verify Signature', desc: 'Offline UIDAI e-Aadhaar validation with a print-ready copy.', icon: ShieldCheck, implemented: true, path: '/verify-signature', category: 'Signatures', color: 'text-teal-600', bg: 'bg-teal-50 dark:bg-teal-900/20' },
]
        ...
        <div className="p-6 pb-2">
          <div className="flex items-center justify-between mb-6">
             <div className="flex items-center gap-3">
                ...
                <div className="w-10 h-10 bg-terracotta-500 text-white rounded-xl flex items-center justify-center shadow-lg shadow-terracotta-500/20">
                   <FileText size={20} />
                </div>
          ...
          >
            ...
            <Suspense fallback={<LoadingSpinner />}>
              <Routes>
                ...
                <Route path="/verify-signature" element={<VerifySignatureTool />} />
