...
const tools: Tool[] = [
  ...
  { title: 'Verify Signature', desc: 'Validate signed PDFs (e-Aadhaar today) and create a print-ready copy.', icon: ShieldCheck, implemented: true, path: '/verify-signature', category: 'Signatures', color: 'text-rose-500', bg: 'bg-rose-50 dark:bg-rose-900/20' },
]
